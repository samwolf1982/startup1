...
/**
 * This is the model class for table "room_rent".
 *
 * @property int $id
 ...
 */
class RoomRent extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['square_total', 'square_live', 'square_kitchen', 'pledge'], 'number'],
            [['rooms_total', 'rooms_divided', 'rooms_for_rent', 'floor', 'floors', 'room_type_id', 'base_type_id', 'repairs_type_id', 'new_bilding_type_id', 'heating_type_id', 'window_view_type_id', 'restroom_type_id', 'balkoon_type_id', 'ceiling_height', 'sleep_place', 'time_rent_type_id', 'period', 'extra_ipoteka', 'extra_rastrochka', 'extra_net', 'extra_phone', 'extra_tv', 'extra_invalid', 'extra_lift', 'extra_clift', 'extra_concierge', 'extra_sequrity', 'extra_musor', 'extra_gas', 'extra_ogoroza'], 'integer'],
    ...
    {
        return $this->hasMany(Objects::className(), ['deal_model_id' => 'id']);
    }
